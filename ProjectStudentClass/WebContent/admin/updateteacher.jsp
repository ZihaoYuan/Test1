<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="com.project.servlet.AdminUpdateTeacherServlet" %>
...
<body>
<form action="../AdminUpdateTeacherServlet" method="post" id="table">
教师户名：<input name="name" value="${teachername }" disabled="disabled">
