<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="com.project.servlet.AdminAddTeacherServlet,com.project.servlet.ExistTeacherServlet" %>
...
<center><form action="../AdminAddTeacherServlet" id="table" method="post" onsubmit="checkform()">
