...
<body>
<center>学生列表</center>
<center><a href="addstudent.jsp">添加学生</a></center>
...
while(rs.next()){
	...
	<td><a href="updatestudent.jsp?id=<%=rs.getInt(1) %>">修改</a>
	<form action="deletestudent.jsp?id=<%=rs.getInt(1) %>&currentPage=<%=currentPage%>">
...
<a href="studentlist.jsp?currentPage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="studentlist.jsp?currentPage=<%=currentPage-1 %>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
<%
for(int i=currentPage-5;i<currentPage;i++){
	if(i>0){
		
	%>
	<a href="studentlist.jsp?currentPage=<%=i %>"><%=i %></a>
	<%
	}
}
...
%>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="studentlist.jsp?currentPage=<%=currentPage+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="studentlist.jsp?currentPage=<%=totalPage %>">末页</a></center>
</td></tr>
<tr><td colspan="4"><center>
第<%=currentPage %>页
</center>
