<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="com.project.servlet.AddStudentServlet,com.project.servlet.ExistStudentServlet" %>
...
<body>
<center>学生注册页面</center>
<center><form action="AddStudentServlet" id="table" method="post" onsubmit="checkform()">
